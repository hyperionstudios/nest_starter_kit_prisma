...
import { UserUpdateOneWithoutLoginsInput } from '../user/user-update-one-without-logins.input';
...
export class LoginUpdateInput {
    ...
    @Field(() => UserUpdateOneWithoutLoginsInput, {nullable:true})
    User?: UserUpdateOneWithoutLoginsInput;
